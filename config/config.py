...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "1912667035").split())
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/iamuput/UputtMusicc",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/amneseey0u"
)  # Example:- https://t.me/kokbisadek
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/UputtSupport"
)  # Example:- https://t.me/uputtSupport
...
VIDEO_STREAM_LIMIT = int(getenv("VIDEO_STREAM_LIMIT", "0"))
...
if PING_IMG_URL:
    if PING_IMG_URL != "assets/uputt.jpeg":
...
if PLAYLIST_IMG_URL:
    if PLAYLIST_IMG_URL != "assets/uputt.jpeg":
...
if GLOBAL_IMG_URL:
    if GLOBAL_IMG_URL != "assets/uputt.jpeg":
...
if STATS_IMG_URL:
    if STATS_IMG_URL != "assets/uputt.jpeg":
